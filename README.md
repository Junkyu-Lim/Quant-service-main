...
**주도주 점수** = 수급강도×0.3 + 거래대금×0.2 + 영업이익CAGR×0.2 + Q_영업이익YoY×0.2 + RSI×0.1
...
각 전략별로 별도의 점수(`주도주_점수`, `우량가치_점수`, `고성장_점수`, `현금배당_점수`, `턴어라운드_점수`)도 계산합니다.
